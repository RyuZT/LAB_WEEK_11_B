...
class ProviderFileManager(
    ...
    fun generatePhotoUri(time: Long): FileInfo.FileInfo {
    ...
    fun generateVideoUri(time: Long): FileInfo.FileInfo {
    ...
    fun insertImageToStore(fileInfo: FileInfo.FileInfo?) {
        fileInfo?.let {
            insertToStore(
                it,
    ...
    fun insertVideoToStore(fileInfo: FileInfo.FileInfo?) {
        fileInfo?.let {
            insertToStore(
                it,
